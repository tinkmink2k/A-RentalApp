...
public class PostVerticalAdapter extends RecyclerView.Adapter<PostVerticalAdapter.ViewHolder> {
    ...
    public PostVerticalAdapter(List<Post> posts, OnPostCallback callback) {
        this.posts = posts;
        this.callback = callback;
    }

    public PostVerticalAdapter(List<Post> posts, OnPostCallback callback, boolean isShowFavorite) {
        this.posts = posts;
        this.callback = callback;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemPostVerticalBinding binding = ItemPostVerticalBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private final ItemPostVerticalBinding binding;
        private final OnPostCallback callback;

        public ViewHolder(ItemPostVerticalBinding binding, OnPostCallback callback) {
